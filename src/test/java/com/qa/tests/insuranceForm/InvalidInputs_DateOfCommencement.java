...
public class InvalidInputs_DateOfCommencement extends BaseTest {
    ...
    private void fillForm() {
        ...
        insurancePage.enterDateOfCommencement("02/14/2021");
        ...
        Assert.assertEquals(insurancePage.getErrorMessageCount(),1);
        Assert.assertEquals(insurancePage.getErrorMessage(), "Date cannot be less than Proposal Date");
    }
}
