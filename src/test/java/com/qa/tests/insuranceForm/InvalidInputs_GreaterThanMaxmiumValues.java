...
public class InvalidInputs_GreaterThanMaxmiumValues extends BaseTest {
    ...
    private void fillForm() {
        insurancePage.enterPolicyTerm("40");
        insurancePage.enterPremiumTerm("20");
        insurancePage.enterSumProposed("130000000");
        insurancePage.enterTermRider("14000000");
        insurancePage.enterTotalAmountDeposited("1000004");
        insurancePage.enterLengthOfService("50");
